...
hi Statement     guifg=#729fcf               gui=none ctermfg=7               cterm=none 
hi Identifier    guifg=#cccccc                        ctermfg=7
hi Type          guifg=#cccccc               gui=none ctermfg=7               cterm=none
hi PreProc       guifg=#cccccc                        ctermfg=7
hi Function      guifg=#cccccc                        ctermfg=7
hi Todo          guifg=#fcaf3e guibg=bg               ctermfg=3  ctermbg=none
hi Keyword       guifg=#cccccc                        ctermfg=7
hi Special       guifg=#cccccc                        ctermfg=7
